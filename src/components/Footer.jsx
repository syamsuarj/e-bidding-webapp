...
const Footer = () => {
  return (
    <footer className="border-t border-border bg-surface" id="footer">
      <div className="container py-14 flex flex-col gap-10 md:flex-row md:justify-between">
        <div className="space-y-4 md:w-1/3">
          <h3 className="text-xl font-semibold text-primary">APAS</h3>
          <p className="text-sm text-slate-600">
            Agrinas Palma Auction System memfasilitasi 17 pabrik sawit PT APN
            untuk menjual CPO, PKO, PKM, dan CPKO secara cepat, transparan, dan
            aman kepada buyer global.
          </p>
        </div>
        <div className="space-y-4 md:w-1/3">
        ...
        {/* <div className="space-y-4" id="login">
          ...
          <p className="text-sm text-slate-600">
            Akses dashboard seller &amp; buyer APAS.
          </p>
          <a
            href="https://e-bidding-webapp.vercel.app/admin/login"
